define(['jquery','ko','uiComponent','Magento_Checkout/js/model/shipping-service'],function($,ko,Component,shippingService){'use strict';return Component.extend({shipping:ko.observable(false),payment:ko.observable(false),review:ko.observable(false),all:ko.observable(false),initialize:function(){this._super();var self=this;self.shipping.subscribe(function(){if(self.shipping()==true){$('#ajax-shipping').show();$('#control_overlay_shipping').show();$('body').addClass('oscHideLoader');}
...
if(shippingService.isLoading()==false){self.shipping(false);}});}});});